    ...
    <View style={style("flex-1")}>
      ...
      <ScrollView
        ...
        <View style={style("max-w-[320px] w-full mx-auto pt-6")}>
          <Text
            style={[
              style("text-white text-[18px] text-center leading-[22px] mb-3 font-bold"),
              { fontFamily: "manrope" },
            ]}>
          ...
          <Text
            style={[
              style("text-[#C7C7C7] text-[16px] leading-[22px] font-regular tracking-[-0.32px] mb-8"),
              { fontFamily: "manrope" },
            ]}>
          ...
          <View style={style("w-full mb-3")}>
            <Text
              style={[
                style("text-[#FDFDFD] text-left text-[16px] tracking-[-0.32px] mb-4 font-regular"),
                { fontFamily: "manrope" },
              ]}>
              1.Персональні дані
            </Text>
            ...
            <TextInput
              ...
              style={[style("border-[2px] border-[#BDBDBD] bg-[#646464] rounded-[23px] px-4 py-3 text-white",
          ...
          <Text
            style={[
              style("text-[#C7C7C7] text-left text-[16px] tracking-[-0.32px] mb-4 font-regular"),
              { fontFamily: "manrope" },
            ]}>
            2.Контакти
          </Text>
          <View style={style("w-full mb-6")}>
            ...
            {errors.phone ? (
              <Text
                style={style("text-red-500 text-[12px] pl-1 mt-1 tracking-[-0.70px]")}>
                {errors.phone}
              </Text>
            ) : (
              <Text
                style={style("text-[#D7D7D7] text-[12px] tracking-[-0.70px] pl-1 mt-1")}>
          ...
          <View style={style("w-full mb-5")}>
            ...
            <Text style={style("text-[#C7C7C7] text-left text-[16px] pt-3 mb-3")}>
            ...
            <Pressable
              ...
              <Text
                style={[style("text-white text-[16px]"), { fontFamily: "manrope" }]}>
                Механіка
              </Text>
            </Pressable>
          ...
          <View>
            <Pressable
              ...
              <View
                ...
                {agreeConsent && <Text style={style("text-black text-xs")}>✓</Text>}
              </View>
            ...
            <Pressable
              ...
              <View
                ...
                {agreePrivacy && <Text style={style("text-black text-xs")}>✓</Text>}
              </View>
